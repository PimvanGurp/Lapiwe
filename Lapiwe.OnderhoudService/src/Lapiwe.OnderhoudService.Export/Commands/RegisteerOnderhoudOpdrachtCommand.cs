...
namespace Lapiwe.OnderhoudService.Export
{
    public class RegisteerOnderhoudOpdrachtCommand : DomainCommand
    {
        ...
        public RegisteerOnderhoudOpdrachtCommand()
        {

        }

        public RegisteerOnderhoudOpdrachtCommand(Guid klantGuid, Guid autoGuid, DateTime aanmeldDatum, int kilometerstand, string opdrachtOmschrijving, bool apk) 
        {
            KlantGuid = klantGuid;
            AutoGuid = autoGuid;
